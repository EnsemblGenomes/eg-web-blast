...
Bio::Tools::Run::Search::EbiWuBlast - Base class for WU-BLAST searches
...
=head1 SYNOPSIS
  ...
  my $runnable = Bio::Tools::Run::Search(-method=>'ebi_wublastn');
...
# Let the code begin...
package Bio::Tools::Run::Search::EbiWuBlast;
use strict;
use File::Copy qw(mv);
  ...
  $PARAMETER_OPTIONS = 
    {
     ...
     '-statistics' =>
     {
      ...
      order   => 100,
      options => [ undef, 'sump', 'poisson','kap' ],
